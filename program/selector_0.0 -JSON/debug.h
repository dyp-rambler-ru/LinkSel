...
// печать парамера
#define _LOOK(x) Serial.print( __LINE__ );  Serial.print(" ");  Serial.print(#x); Serial.print("="); Serial.println( (x) );
        
#define _PRN(x) Serial.print( __LINE__ );  Serial.print(" ");  Serial.println( (x) );
...
#define _MFREE Serial.print( __LINE__ );  Serial.print("Memory FREE= "); Serial.println(memoryFree() );
